...
public class OperacionesDwrAction extends AbstractBaseDwrAction {
	...
	private StringBuffer writeMOSinDueno(String idPersona, String ruta, String idAcreedor){
		...
		try{		
			...
			sb.append(" <tr> ");
			sb.append(" <td class=\"tituloInteriorRojo\">Operaciones Sin dueï¿½o</td> ");
			sb.append(" </tr> ");			
			sb.append(" <tr> <td> ");
...
//	Metodos para Implementaciï¿½n de Paginaciï¿½n
...
//			int idUsuario =  getUser().getIdUsuario();
			...
			System.out.println("Lista Pendientes de Firma Tamaï¿½o: "+listaPendientes.size());
			StringBuffer sb = new StringBuffer();
//			sb.append("<div align=\"right\">")
