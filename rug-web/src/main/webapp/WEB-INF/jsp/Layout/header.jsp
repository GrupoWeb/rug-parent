...
<!-- 			<a href="#" data-activates="slide-out" class="sidenav-trigger btn-floating btn-flat waves-effect waves-light transparent"><i class="material-icons">menu</i></a> -->
			<a href="#" data-activates="slide-out" class="btn-menu btn-floating btn-flat waves-effect waves-light transparent"><i class="material-icons">menu</i></a>
    	</li>
	    <%
		}
		%>
    ...
    <ul class="right">
		...
		if (session.getAttribute(Constants.USUARIO) == null) {
		%>
      	<li><a href="<%= request.getContextPath() %>/usuario/add.do" class="hide-on-med-and-down waves-effect red darken-4 waves-light btn">Registrarse</a></li>
		...
		<li class="hide-on-med-and-down"><a href="<%=request.getContextPath()%>/home/logout.do" class="waves-effect red darken-4 waves-light btn">Salir</a></li>
		<li class="hide-on-large-only">
			<a href="<%=request.getContextPath()%>/home/logout.do" class="btn-floating btn-flat waves-effect waves-light transparent">
