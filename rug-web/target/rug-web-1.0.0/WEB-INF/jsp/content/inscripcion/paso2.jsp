			...
			<div class="col s12">
				<div class="card">
					...
					<div class="col s10">
						...
						<div class="row">
							<s:form action="agregarGarantia.do" namespace="inscripcion" theme="simple" id="formS2ag" name="formS2ag" acceptcharset="UTF-8" method="post">
								<div class="row">
							 		<div class="card">
						        		<div class="card-content">
						        			...
						        			<div class="row">
										    	<div class="input-field col s12">
										    		<s:textarea rows="10" id="descripcionId" cols="80"
																	onchange="replaceValue('descripcionId')"
								...
								<div class="row">							    	
						        	<div class="card">
						        		<div class="card-content">
								        	<div class="row">
										    	<p>
										        	<input type="checkbox" name="actoContratoTO.noGarantiaPreviaOt" id="actoContratoTO.noGarantiaPreviaOt" value="true"/>							        	
										        	<label for="actoContratoTO.noGarantiaPreviaOt">Declaro que de conformidad con el contrato de garant&iacute;a, el deudor declar&oacute; que sobre los bienes en garant&iacute;a no existen otro gravamen, anotaci&oacute;n o limitaci&oacute;n previa.</label>
										   		</p>
										 	</div>							 	
										 	<div class="row">
										    	<p>
										        	<input type="checkbox" name="actoContratoTO.cambiosBienesMonto" id="actoContratoTO.cambiosBienesMonto" value="true"/>
										        	<label for="actoContratoTO.cambiosBienesMonto">Los atribuibles y derivados no esta afectos a la Garant&iacute;a Mobiliaria</label>
										   		</p>
										 	</div>
										 	<div class="row">
										    	<p>
										        	<input type="checkbox" name="actoContratoTO.garantiaPrioritaria" id="actoContratoTO.garantiaPrioritaria" value="true" onclick="esPrioritaria()"/>
										        	<label for="actoContratoTO.garantiaPrioritaria">Es prioritaria la garant&iacute;a mobiliaria</label>
										   		</p>
										 	</div>
										 	<div class="row">							    	
									    		<p>							    		
									    			<input type="checkbox" name="actoContratoTO.cpRegistro" id="actoContratoTO.cpRegistro" value="true" onclick="otroRegistro()"/>
									        		<label for="actoContratoTO.cpRegistro">El bien se encuentra en otro registro</label>
									        	</p>
									        </div>
									        <div class="row">						   		
										   		<div class="input-field col s6">
										    		<s:textarea name="actoContratoTO.txtRegistro" id="actoContratoTO.txtRegistro" disabled="true"/>						    	 								        	
							 		...
							 		<div class="card">
						        		<div class="card-content">
						        			...
						        			<div class="row">
							        			...
							        			<label for="actoContratoTO.instrumentoPub">Informaci&oacute;n general del contrato de la Garant&iacute;a(Lugar y Fecha, tipo de documento, monto inicial garantizado, plazo, etc.)</label>
										   		</div>
										 	</div>										 										 	
						        		</div>
						        	</div>							    	
							 	...
							 	<center>
						            <div class='row'>
						            	<input type="button" class="btn btn-large waves-effect indigo" value="Regresar" id="buttonID" onclick="paso1()" />
						            	<input type="button" class="btn btn-large waves-effect indigo" onclick="msg_guardar()" value="Guardar" id="guardarID" />			            	
						            	<input onclick="seguroContinuar()" class="btn btn-large waves-effect indigo" value="Continuar" type="button" id="baceptar" />						            	
						            </div>
					          	</center>	
							</s:form>							
  ...
  function esPrioritaria() {
	  ...
	  if (checkBox.checked == true) {
		  MaterialDialog.alert(
		    	    ...
		    	    'pasarán a formar parte del inventario el deudor garante, el acreedor garantizado que financie adquisicion ' +
